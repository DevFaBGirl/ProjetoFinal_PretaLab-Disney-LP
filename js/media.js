...
function calcularMedia() {
  ...
  else if (media >= 0.1 && media <= 3) {mensagem = "Caramba, deu ruim, você obteve média" + media + "! Estude mais e tente novamente!";} 
  else if (media >= 3.1 && media <= 5.9) {mensagem = "Você obteve média" + media + " ! Falta pouco para a média.";} 
  else if (media >= 6 && media <= 7) {mensagem = "Você está na média com" + media ;} 
  else if (media >= 7.1 && media <= 9.9) {mensagem = "Notão! Sua média é" + media + "!";} 
  else {mensagem = "Hoje é seu aniversário? Porque você ta de parabéns! 10 de média";}
